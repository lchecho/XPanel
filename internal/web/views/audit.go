...
var auditActionLabels = []Option{
	...
	{domain.ActionPortChanged, "更换端口"}, {domain.ActionPortAssigned, "分配端口"}, {domain.ActionPortReleased, "释放端口"},
	{domain.ActionInboundCreated, "创建入站"}, {domain.ActionInboundRemoved, "移除入站"},
